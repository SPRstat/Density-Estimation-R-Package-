...
#' 
#' Obtain densiTy estimate of a vector using beta pdf
...
#' 
#' 
#' @author Snehashis De, Samya Praharaj 
#' 
...
#' 
#' 
#' @author Snehashis Dey, Samya Praharaj 
#' 
#' 
#' @export
#' 
...
#' 
#' 
#' @author Snehashis Dey, Mainak Manna 
#' 
#' 
#' @export
#' 
...
#' @author Mainak Manna, Samya Praharaj 
#' 
#' @return Returns the value of theoretical MISE and optimal bandwidth in given vector
#' 
#' @export
#' 
...
#' Finding theoretical Mean Integrated square error
#' 
#' To Find theoretical Mean Integrated Square Error for different distributions with restrictions on the support using different kernel functions  using optimal bandwidth
#' 
#' @param expr If not NULL, then the distribution for which MISE is to be calculated; Default NULL and uses normal density
#' @param kern kernel
#' @param l1,u1 lower and upper bound of support of the density function
...
#' Finding theoretical Mean Integrated square error
#' 
#' To Find theoretical Mean Integrated Square Error for different distributions with restrictions on the support using specific kernel functions which can take negative values for bias reuction, using optimal bandwidth
#' 
#' @param expr If not NULL, then the distribution for which MISE is to be calculated; Default NULL and uses normal density
#' @param kern kernel
#' @param l1,u1 lower and upper bound of support of the density function
...
#' Calculating MISE for L2 loss using Monte Carlo Simulation
#' 
#' To approximate MISE for L2 loss using Monte Carlo Simulation for different distributions  
#' 
#' @param func1 function to simulate data from required distribution; Default value rnorm
#' @param func2 density function of required distribution
#' @param Func  density estimate
#' @param l1,u1 lower and upper bound of support of the kernel function
#' 
#' 
#' @author Mainak Manna, Samya Praharaj 
#' 
#' @return Returns the approximate MISE for L2 loss using Monte Carlo Simulation
#' 
#' @export
#' 
...
#' Calculating MISE for L1 loss using Monte Carlo Simulation
#' 
#' To approximate MISE for L1 loss using Monte Carlo Simulation for different distributions  
#' 
#' @param func1 function to simulate data from required distribution; Default value rnorm
#' @param func2 density function of required distribution
#' @param Func  density estimate
...
#' @author Mainak Manna, Samya Praharaj 
#' 
#' @return Returns the approximate MISE for L1 loss using Monte Carlo Simulation
#' 
#' @export
#' 
...
#' Plotting asymptotic normality of kernel density estimates
#' 
#' This function can be used to observe rate of convergence to normality by varying sample  size, location , underlying distribution and kernel function.
#' 
#' @param u Numeric value; Distance from location
#' @param n Numeric value; Sample Size
#' @param expr  expression for density; Default value is NULL
#' @param rs function from which random sample of the specific distribution will be generated.
#' @param ker_f kernel function
#' @param h0 Numeric value; Bandwidth
#' 
#' 
#' @author Mainak Manna, Samya Praharaj 
#' 
#' @return Returns the plot of kernel density estimates
#' 
#' @export
#' 
...
#' 
#' This function can be used to find the integrated square error for different bandwidths
#' 
#' @param v Vector value; The vector of observations
#' @param l1,u1 lower and upper bound of support of the kernel function with default values -Inf and Inf respectively
#' @param h Vector value; Bandwidth with default value 0.1
#' @param kern kernel function
#'
#' @author Mainak Manna, Samya Praharaj 
#' 
#' @return Returns the value of Integrated Square Error 
#' 
#' @export
#'
